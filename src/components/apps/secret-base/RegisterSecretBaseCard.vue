              ...
              <div class="row">
                <div class="col-6">
                  <q-list bordered>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.calories.toFixed(1) }}</q-item-label>
                        <q-item-label caption lines="1">칼로리(Kcal)</q-item-label>
                      </q-item-section>
                    </q-item>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.carbohydrates.toFixed(1) }}</q-item-label>
                        <q-item-label caption lines="1">탄수화물(g)</q-item-label>
                      </q-item-section>
                    </q-item>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.protein.toFixed(1) }}</q-item-label>
                        <q-item-label caption lines="1">단백질(g)</q-item-label>
                      </q-item-section>
                    </q-item>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.fat.toFixed(1) }}</q-item-label>
                ...
                <div class="col-6">
                  <q-list bordered>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.sugars.toFixed(1) }}</q-item-label>
                        <q-item-label caption lines="1">당류(g)</q-item-label>
                      </q-item-section>
                    </q-item>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.caffeine.toFixed(1) }}</q-item-label>
                        <q-item-label caption lines="1">카페인(mg)</q-item-label>
                      </q-item-section>
                    </q-item>
                    <q-item class="q-my-sm" clickable v-ripple>
                      <q-item-section>
                        <q-item-label>{{ totalIngredients.saturatedFat.toFixed(1) }}</q-item-label>
